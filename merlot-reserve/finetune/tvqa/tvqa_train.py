...
config['data']['train_fns'] = "/data/preprocessed/baseline/out/train{:03d}of256.tfrecord"
...
config['device']['output_dir'] = os.path.join("/home/sheryl/out", cfg_name)
if args.output_name != '':
...
def val_epoch(state: train_state.TrainState):
    ...
    val_config['data']['val_fns'] = "/data/preprocessed/baseline/out/val{:03d}of008.tfrecord"
