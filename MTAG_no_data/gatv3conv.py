...
class GATv3Conv(MessagePassing):
    r"""The GATv3 operator from the `"How Attentive are Graph Attention Networks?"
    ...
    node. In contrast, in GATv3, every node can attend to any other node.
    ...
    def __init__(self, lin_l_layer, lin_r_layer, in_channels: int, out_channels: int, heads: int = 1,
        ...
        # params to be able to access attention weights without going through forward abstraction b/c breaks heteroconv
        self.edge_index_ret = {}
        self.alpha_ret = {}
    ...
    def forward(self, x: Union[Tensor, PairTensor], edge_index: Adj,
                size: Size = None, edge_type: dict = None, return_attention_weights: bool = None):
        ...
        # pass back edge idxs and alpha
        self.edge_index_ret[edge_type] = edge_index
        self.alpha_ret[edge_type] = alpha
