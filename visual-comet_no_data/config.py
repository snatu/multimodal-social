...
VCR_IMAGES_DIR = '/home/shounak_rtml/11777/visual-comet/images2/social_iq'# os.environ['VCR_PARENT_DIR']
if not os.path.exists(VCR_IMAGES_DIR):
    raise ValueError("Update config.py with where you saved VCR images to.")

VCR_FEATURES_DIR = '/home/shounak_rtml/11777/visual-comet/socialiq_features'
