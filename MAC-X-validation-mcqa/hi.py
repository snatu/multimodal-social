...
val_dataset = SocialIQ('/ocean/projects/dmr120014p/sulagna/Social-IQ/code/socialiq/', 'val', mods={'ac', 'v', 't'}, a4=True)
...
def com_val(corrs, acc_loss, preds, l, loss, a4=False):
    ...
    if not a4:
        ...
        print(correct, incorrects)
        acc_loss += loss

    return corrs, acc_loss

binary_qa = torch.load('/ocean/projects/dmr120014p/sulagna/mcqa.pth')
