...
val_dataset = SocialIQ('/ocean/projects/dmr120014p/sulagna/Social-IQ/code/socialiq/', 'val', mods={ 'v', 't'})
...
binary_qa = torch.load('/ocean/projects/dmr120014p/sulagna/binaryqa_VT.pth')
